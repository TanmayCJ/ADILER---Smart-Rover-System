"""Run LangGraph workflow on a synthetic scenario."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run LangGraph rover workflow")
    ...
    try:
        ...
        print(f"LangGraph workflow failed: {exc}")
        raise
    ...
    print("Memory events:", len(memory_events))
    if memory_events:
        print("Last memory event:", memory_events[-1])
